...
class DataRecorder:
    ...
    CSV_FIELDS = {
        'chat':      ['time', 'user_id', 'douyin_id', 'user_name', 'gender', 'content', 'grade', 'fans_club', 'sec_uid', 'avatar_url'],
        'lucky_bag': ['time', 'user_id', 'douyin_id', 'user_name', 'gender', 'content', 'grade', 'fans_club', 'sec_uid', 'avatar_url'],
        'contribution': ['time', 'rank_pos', 'user_id', 'user_name', 'score'],
        'gift':      ['time', 'user_id', 'douyin_id', 'user_name', 'gender', 'gift_name', 'gift_count', 'diamond_total', 'grade', 'fans_club', 'sec_uid', 'avatar_url', 'group_id', 'raw_repeat_count', 'raw_repeat_end', 'raw_combo_count', 'raw_total_count', 'log_id', 'trace_id', 'send_time', 'priority_score', 'fold_type', 'anchor_fold_type', 'msg_filter_k', 'msg_filter_v', 'is_dispatch', 'queue_priority'],
        'like':      ['time', 'user_id', 'user_name', 'count', 'total', 'grade', 'fans_club', 'sec_uid', 'avatar_url'],
        'member':    ['time', 'user_id', 'user_name', 'gender', 'grade', 'fans_club', 'sec_uid', 'avatar_url', 'member_count'],
        'social':    ['time', 'user_id', 'user_name', 'action', 'follow_count', 'grade', 'fans_club', 'sec_uid', 'avatar_url'],
        'fansclub':  ['time', 'user_id', 'user_name', 'type', 'content', 'grade', 'fans_club', 'sec_uid', 'avatar_url'],
        'emoji':     ['time', 'user_id', 'user_name', 'emoji_id', 'content', 'grade', 'fans_club', 'sec_uid', 'avatar_url'],
        'stats':     ['time', 'popularity', 'up_right_stats_str', 'up_right_stats_complete', 'current', 'total_pv', 'total_user', 'online_anchor'],
        'roomstats': ['time', 'detail', 'total'],
        'room':      ['time', 'is_top', 'room_id', 'content', 'biz_scene'],
        'rank':      ['time', 'rank_pos', 'user_id', 'douyin_id', 'user_name', 'score', 'sec_uid', 'avatar_url'],
        'control':   ['time', 'status'],
        'pk_event':  ['time', 'method', 'payload_len', 'pk_type', 'status_text', 'opponent_id', 'duration_sec', 'score_self', 'total_display', 'linker_id', 'mode', 'aux_type', 'user_id_a', 'user_id_b'],
        'pk_round':  ['start_time', 'end_time', 'duration_sec', 'mode', 'participants', 'participant_count', 'opponent_id', 'self_score', 'result'],
        'subscribe': ['time', 'user_name', 'douyin_id', 'event', 'action', 'sub_type', 'diamond'],
        'light_gift': ['time', 'user_id', 'gift_id', 'diamond_count', 'count', 'diamond_total', 'msg_type'],
    }
                ...
                with self._record_lock:
                    ...
                    if buf is not None:
                        for row in reversed(batch[failed_idx:]):
                            buf.appendleft(row)
                logger.warning(f"[数据] CSV 写入异常，{len(batch) - failed_idx} 条数据已回退: {last_err}")
