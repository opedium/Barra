...
class DataRecorder:
    ...
    CSV_FIELDS = {
        'chat':      ['time', 'user_id', 'douyin_id', 'user_name', 'gender', 'content', 'grade', 'fans_club'],
        'lucky_bag': ['time', 'user_id', 'douyin_id', 'user_name', 'gender', 'content', 'grade', 'fans_club'],
        'contribution': ['time', 'rank_pos', 'user_id', 'user_name', 'score'],
        'gift':      ['time', 'user_id', 'douyin_id', 'user_name', 'gender', 'gift_name', 'gift_count', 'diamond_total', 'grade', 'fans_club', 'group_id', 'raw_repeat_count', 'raw_repeat_end', 'log_id', 'trace_id', 'send_time', 'priority_score', 'fold_type', 'anchor_fold_type', 'msg_filter_k', 'msg_filter_v', 'is_dispatch', 'queue_priority'],
        ...
        'rank':      ['time', 'rank_pos', 'user_id', 'douyin_id', 'user_name', 'score'],
        'control':   ['time', 'status'],
